...
<div class="content">
            <p>
              Yêu cầu cấp lại mật khẩu cho tài khoản Tuyển dụng tại <a>Jobvieclam.com</a>:
            </p>
            <p>Kính chào Công Ty {{$fullName}} </p>
            <p>
              Để hoàn tất yêu cầu thay đổi mật khẩu, vui lòng nhấn vào liên kết dưới đây:
            </p>
            <a href="https://tuyendung.jobvieclam.com/employer/forgotpassword?code={{$codeGen}}" target="_blank" rel="noopener noreferrer">https://tuyendung.jobvieclam.com/employer/forgotpassword?code={{$codeGen}}</a>
